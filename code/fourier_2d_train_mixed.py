...
def read_train_data(input_dir,ntrain):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".mat") and( '1_10' in filename ) :
...
RESULT_PATH = '../results/train_' + train_ratio + '_test_' + test_ratio + '/' + model_name + '_1_10.mat'
MODEL_PATH = '../models/train_' + train_ratio + '_test_' + test_ratio + '/' + model_name+'_1_10'
