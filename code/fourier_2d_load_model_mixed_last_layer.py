...
TRAIN_PATH = '../data/Darcy/Darcy_1_24_0.5/output1_24_train_1000.mat'
train_ratio = "mixed"
...
lx_train = reader.read_field('coeff')[:lntrain, ::r, ::r][:, :s, :s]
ly_train = reader.read_field('sol')[:lntrain, ::r, ::r][:, :s, :s]
...
lx_train = x_normalizer.encode(lx_train)
x_test = x_normalizer.encode(x_test)
#
y_normalizer = UnitGaussianNormalizer(y_train)
ly_train = y_normalizer.encode(ly_train)
y_normalizer.cuda()

lx_train = lx_train.reshape(lntrain, s, s, 1)
x_test = x_test.reshape(ntest, s, s, 1)

train_loader = torch.utils.data.DataLoader(torch.utils.data.TensorDataset(lx_train, ly_train), batch_size=batch_size,
                                           shuffle=True)
