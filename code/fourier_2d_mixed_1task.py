...
def read_train_data(input_dir,ntrain):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".mat") and 'f_3' in filename :
...
train_ratio = "f"
train_dir = '../data/Darcy/Meta_data_f_test'

x_train, y_train = read_train_data(train_dir, 780)
test_ratio = "3_12"

model_name = train_ratio+'train_780_2_subtask__with_norm_train_model'
...
x_test_pretrain = reader.read_field('coeff')[780:780+ntest_pretrain, ::r, ::r][:, :s, :s]
y_test_pretrain = reader.read_field('sol')[780:780+ntest_pretrain, ::r, ::r][:, :s, :s]
